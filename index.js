...
function addToggleButton() {
    ...
    button.id = 'community-board-toggle';
    button.title = 'Community Board 토글';
    button.textContent = '📋';
    if (settings.enabled) button.classList.add('active');
...
function updateToggleButton(enabled) {
    const btn = document.getElementById('community-board-toggle');
